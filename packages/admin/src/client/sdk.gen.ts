 ...
 */
export const taskCompletionsControllerDeleteVideo = <ThrowOnError extends boolean = false>(options: Options<TaskCompletionsControllerDeleteVideoData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
...
export const studymappingControllerWebhook = <ThrowOnError extends boolean = false>(options: Options<StudymappingControllerWebhookData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
...
export const studymappingControllerUploadCsv = <ThrowOnError extends boolean = false>(options: Options<StudymappingControllerUploadCsvData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
